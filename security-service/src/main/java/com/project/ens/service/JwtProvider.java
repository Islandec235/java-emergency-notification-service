...
import com.project.ens.exception.BadRequestException;
...
public class JwtProvider {
    ...
    private boolean validateToken(@NonNull String token, @NonNull Key secret) {
        try {
            ...
            throw new BadRequestException("Веб-токен JSON не поддерживается");
        } catch (MalformedJwtException e) {
            throw new BadRequestException("Неправильно сформированный веб-токен JSON");
        } catch (SignatureException e) {
            throw new UnauthorizedException("Недействительная подпись");
        } catch (Exception e) {
